...
public class databasedoctruyen extends SQLiteOpenHelper{
    ...
    private String SQLQuery3 = "INSERT INTO TaiKhoan VAlUES (null,'long','long','long@gmail.com',1)";
    ...
    // Truyện Conan
    private String SQLQuery5 = "INSERT INTO truyen VALUES (null,'Conan','Ông đã đến rồi trời lạnh buốt, Conan không có gì để ăn cả. Conan mặc áo vào rồi ra ngoài kiếm thức ăn. Nó đi mãi đi mãi cuối cùng cũng tìm được hai củ cải trắng. Conan reo lên:\n" +
            "\n" +
            "– Ôi, ở đây có hai củ cải trắng liền, mình thật là may mắn!\n" +
            "\n" +
    ...
    private String SQLQuery6 = "INSERT INTO truyen VALUES (null,'One Piece','Luffy đen và Luffy trắng cùng sống trong một khu rừng. Hàng ngày, cả hai thường đến uống nước và tìm cái ăn ở trong khu rừng quen thuộc.\n" +
            ...
            "\n" +
            "Ý nghĩa câu chuyện: Qua câu chuyện ngụ ngôn trên, bạn có thể truyền tải nhiều thông điệp khác nhau cho bé hiểu. Chẳng hạn như biết cách ứng xử trước các tình huống khó, nguy hiểm, lạc quan và bản lĩnh để xử lý vấn đề.'," +
            "'https://www.cgv.vn/media/catalog/product/cache/1/image/c5f0a1eff4c394a251036189ccddaacd/p/o/poster_one_piece_3_-_final_main_version_1_.jpg',1)";
    ...
    private String SQLQuery7 = "INSERT INTO truyen VALUES (null,'Chú bé chăn cừu','Một chú bé chăn cừu cho chủ thả cừu gần một khu rừng rậm cách làng không xa lắm. Chăn cừu được ít lâu, chú cảm thấy công việc chăn cừu thực là nhàm chán. Tất cả mọi việc chú có thể làm để giải khuây là nói chuyện với con chó hoặc thổi chiếc sáo chăn cừu của mình.\n" +
            ...
            "'https://img.tripi.vn/cdn-cgi/image/width=700,height=700/https://gcs.tripi.vn/public-tripi/tripi-feed/img/474096lxo/hinh-nen-dragon-ball-dep-cho-dien-thoai_030207990.jpg',1)";
    ...
    public void UpdateTruyen(String tentruyen, String noidung) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(NOI_DUNG, noidung);
        db.update(TABLE_TRUYEN, values, TEN_TRUYEN + " = ?", new String[] { String.valueOf(tentruyen) });
    }
    ...
    public Cursor getData1(){
        SQLiteDatabase db = this.getReadableDatabase();
        return db.rawQuery( "select * from "+TABLE_TRUYEN+" ORDER BY "+ID_TRUYEN+" DESC LIMIT 6" , null );
    }

    public Cursor getData4(){
        SQLiteDatabase db = this.getReadableDatabase();
        return db.rawQuery( "select * from "+TABLE_TRUYEN+" ORDER BY "+ID_TRUYEN+" DESC LIMIT 7" , null );
    }
    ...
    public Cursor getData3(){
        SQLiteDatabase db = this.getReadableDatabase();
        return db.rawQuery("SELECT * FROM " + TABLE_DANH_GIA,null);
    }
    ...
    public int Delete(int i){
        SQLiteDatabase db = this.getReadableDatabase();
        return db.delete("truyen",ID_TRUYEN + " = " + i,null);
    }
}
